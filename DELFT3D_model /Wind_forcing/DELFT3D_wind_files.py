...
nc_fileID = '/Users/lienzo/Desktop/Thesis/Runs/Definitive/inner/Curacao-wind.nc'
e=Dataset(nc_fileID)
w=xr.open_dataset(nc_fileID).sel(time=slice('2022-02-20T00:00:00.000000000', '2022-04-03T00:00:00.000000000'))
...
root =xr.open_dataset(nc_fileID).sel(time=slice('2022-02-20T00:00:00.000000000', '2022-04-03T00:00:00.000000000'))
print(root)
dims = root.dims
ndims = len(dims)
...
for i in iter_var:
    ...
    dir='/Users/lienzo/Desktop/'
    outfile_name = dir+str(i)+'_'+month+fmt
    ...
    x_llcorner = root.variables[longitude_name][0].values
    y_llcorner = root.variables[latitude_name][-1].values
    ...
    outfile.write('dx = '+str(dx.values)+'\n')
    outfile.write('dy = '+str(dy.values)+'\n')
    ...
    for t in range(int(input('time to write '+i+'(time size ' + str(vars['time'].shape) + '): '))):
        ...
        t_true=time1.values
        outfile.write('TIME = ' + str(t) + ' hours since 2022-02-20 00:00:00 +00:00\n')
...
for i in iter_var:
    ...
    for t in range(int(input('time to write : '))):
        # time1 = root.variables[time_name][t]
        outfile.write('TIME = ' + str(t) + ' hours since 1900-01-01 00:00:00 +00:00\n')
        # FOR SINGLE MONTH WRITE USE THIS:
